...
import {
    ...
    DatePickerInput,
    ModalBody,
    TextArea, RadioButton, Checkbox, TileGroup
} from '@carbon/react';
import { Add, TrashCan, ColumnDependency, LoadBalancerVpc, ParentChild, Task, TaskAdd, OverflowMenuVertical } from '@carbon/react/icons';
        ...
        <Grid>
            ...
            {modal ?
                ...
                <div className={'outer-tile'}>
                    <Grid>
                        <Column lg={{ span: 2 }} md={{span:2}}>
                            <h5>New</h5>
                        </Column>
                        <Column lg={{ span: 1, start: 5 }} md={{span:2, start:8}} sm={{span:1, start:4}}>
                            <OverflowMenuVertical size={'32'} onClick={() => { showModal(true)}} />
